...
class Cat:
    ...
    def update(self, ID, IDs, ss, n_p):
        ...
        if n_p > 0:
            ...
            print("Cat: " + str(timeit.default_timer() - start_time))
            return loss
...
class Cont:
    ...
    def update(self, ID, IDs, ss, n_p):
        ...
        print("Cont: " + str(timeit.default_timer() - start_time))
        return loss
...
class Contbin:
    ...
    def update(self, ID, IDs, ss, n_p):
        ...
        print("Contbin: " + str(timeit.default_timer() - start_time))
...
class Bicontbin:
    ...
    def update(self, ID, IDs, ss, n_p):
        ...
        print("Bicontbin: " + str(timeit.default_timer() - start_time))
        return (loss_cont, loss_bin)
